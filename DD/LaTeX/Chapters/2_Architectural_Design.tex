...
\begin{itemize}
    \item \textbf{Automated Trigger component:} .
    \item \textbf{View Matches component:} .
\end{itemize}
...
\begin{itemize}
    \item \textbf{View internship component:} .
    \item \textbf{Create internship component:} .
    \item \textbf{Modify internship component:} .
    \item \textbf{Apply internship component:} .
    \item \textbf{Search internship component:} .
    \item \textbf{Create feedback component:} .
    \item \textbf{View Candidates component:} .
\end{itemize}
...
\begin{itemize}
    \item \textbf{Create Complaint component:} .
    \item \textbf{Open Chat component:} .
\end{itemize}
...
\begin{itemize}
    \item \textbf{Create Task component:} .
    \item \textbf{Select Candidates component:} .
\end{itemize}
