...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\linewidth]{DD/LaTeX/Images/RuntimeView/ViewAndUpdateTheirProfile.png}
...
\item GetStudentRecommendedInternships(\textit{String} email)
...
\begin{itemize}
    \item \textbf{\textbf{ExternalToolServer}}
\begin{itemize}
