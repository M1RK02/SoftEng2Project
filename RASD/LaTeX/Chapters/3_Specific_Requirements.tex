...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\linewidth]{UseCaseDiagrams/User.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\linewidth]{UseCaseDiagrams/SeC.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Login.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.4\textwidth]{SequenceDiagrams/Logout.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/View_And_Update.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{SequenceDiagrams/Search_Internships.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.55\textwidth]{SequenceDiagrams/Apply_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{SequenceDiagrams/Accept_Reject_Offers.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=\textwidth]{SequenceDiagrams/Complete_Questionnaires.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Provide_Feedback.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/File_Complaints.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/Create_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.65\textwidth]{SequenceDiagrams/View_Manage_Internships.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{SequenceDiagrams/View_Recommended_Students.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Contact_Students.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/Accept_Student_Applications.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{SequenceDiagrams/Submit_Questionnaires_Students.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/Finalize_Selection_Process.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Provide_Feedback_Interns.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/File_Complaints_Students.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{SequenceDiagrams/Monitor_Student_Internships.png}
        \caption{File complaints about students sequence diagram.}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\textwidth]{SequenceDiagrams/Handle_Internships_Complaints.png}
        \caption{File complaints about students sequence diagram.}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Cancel_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/Improve_Recommendation_Algorithm.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.7\textwidth]{SequenceDiagrams/Inform_Companies.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{SequenceDiagrams/Inform_Students.png}
