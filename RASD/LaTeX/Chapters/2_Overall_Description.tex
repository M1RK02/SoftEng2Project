...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Domain_Class_Diagram.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Update_CV.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Publish_An_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Search_For_An_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Apply_For_An_Internship.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Ask_For_A_ST_Application.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Reviewing_An_Apply_Request.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Create_Task_For_Interviews.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Solve_Tasks_And_Questionnaires.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{StateDiagrams/Finalize_Selections.png}
