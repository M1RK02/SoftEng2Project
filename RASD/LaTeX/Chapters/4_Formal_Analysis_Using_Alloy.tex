...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{Alloy/baseWorld_magic.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.4\linewidth]{Alloy/world_magic.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.4\linewidth]{Alloy/world2_magic.png}
